<template>
  <div class="coupon-operating">
    <div class="coupon-operating_search">
      ...
      <base-item inline><template slot="label">激活起始序列号:</template><el-input size="small"/></base-item>
      <base-item label-width="45px" inline><template slot="label">张数:</template><el-input  size="small"/> <el-button size="small" type="primary" round>激活</el-button></base-item>
      <base-item inline><template slot="label">撤销起始序列号:</template><el-input size="small"/></base-item>
      <base-item label-width="45px" inline><template slot="label">张数:</template><el-input  size="small"/> <el-button size="small" type="primary" round>撤销</el-button></base-item>
    </div>
