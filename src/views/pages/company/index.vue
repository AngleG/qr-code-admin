<template>
    <div class="company-wrap">
      ...
      <el-button @click="saveCompanyInfo" class="confirm" type="primary" round>保存修改</el-button>
    </div>
</template>
...
<script>
  ...
  import webApi from '../../../lib/api'
    ...
    methods: {
       ...
       */
      async upload() {
        let res = await webApi.upload(this.logoFile, {loginkey: localStorage.getItem('loginkey'), companykey: this.requestParams.companykey});
        if (res.flags === 'success') {
          if (res.data) {
